...
export const productSchema: CollectionCreateSchema = {
  ...
  fields: [
    ...
    { name: 'name_ar', type: 'string', optional: true },
    ...
    { name: 'short_description_ar_norm', type: 'string', locale: 'ar', optional: true },
    { name: 'long_description_en', type: 'string', optional: true },
    { name: 'long_description_ar', type: 'string', locale: 'ar', optional: true },
    { name: 'long_description_ar_norm', type: 'string', locale: 'ar', optional: true },
    ...
    { name: 'brand_name_ar_norm', type: 'string', locale: 'ar', optional: true },
    ...
    { name: 'category_names_ar_norm', type: 'string[]', locale: 'ar', optional: true },
